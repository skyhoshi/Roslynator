# AsExpressionInfo\.Equals Method
...
| Method | Summary |
| ------ | ------- |
| Equals\(AsExpressionInfo\) | Determines whether this instance is equal to another object of the same type\. |
