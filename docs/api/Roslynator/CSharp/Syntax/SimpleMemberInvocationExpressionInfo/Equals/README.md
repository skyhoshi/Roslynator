# SimpleMemberInvocationExpressionInfo\.Equals Method
...
| Equals\(SimpleMemberInvocationExpressionInfo\) | Determines whether this instance is equal to another object of the same type\. |
