# SingleLocalDeclarationStatementInfo\.Equals Method
...
| Equals\(SingleLocalDeclarationStatementInfo\) | Determines whether this instance is equal to another object of the same type\. |
...
## Equals\(SingleLocalDeclarationStatementInfo\)
