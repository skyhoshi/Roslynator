# StringConcatenationExpressionInfo\.Equals Method
...
| Equals\(StringConcatenationExpressionInfo\) | Determines whether this instance is equal to another object of the same type\. |
