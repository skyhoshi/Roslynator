# UsingDirectiveListInfo\.Equals Method
...
| Equals\(UsingDirectiveListInfo\) | Determines whether this instance is equal to another object of the same type\. |
