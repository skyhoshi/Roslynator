# SingleParameterLambdaExpressionInfo\.Equals Method
...
| Equals\(SingleParameterLambdaExpressionInfo\) | Determines whether this instance is equal to another object of the same type\. |
