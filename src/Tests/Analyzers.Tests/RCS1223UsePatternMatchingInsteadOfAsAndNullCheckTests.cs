...
{
    public static class RCS1223UsePatternMatchingInsteadOfAsAndNullCheckTests
    {
        ...
        [Fact]
        public static void TestDiagnosticWithCodeFix_EqualsToNull()
        {
...
",
        ...
        [Fact]
        public static void TestDiagnosticWithCodeFix_IsNull()
        {
            VerifyDiagnosticAndFix(
@"
class C
